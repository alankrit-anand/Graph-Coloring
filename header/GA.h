...
class GA
{
    public:
        ...
        */
        GA(int n_individuals, int n_genes, int n_edges, vector<vector<int>> main_graph);

        /*  Initialize a GA without a population
        */
        GA(int n_genes, int n_edges, vector<vector<int>> main_graph);
        ...
        */
        vector<Individual> Reproduce(vector<Individual> population, int new_ind);
        ...
        /*  Will generate a new population based on a previous one, using the mutate method
            ...
            return: the new population
        */
        vector<Individual> Mutate(vector<Individual> population, int new_ind);
        ...
        */
        int fitnessOfIndividual(int index);
        ...
        */
        bool CorrectColor(int n_colors, double percentage);
        ...
        */
        void MainLoop(int max_iterations, int &total_iterations,double p_best,double p_cross,double p_mutation, int min_colors);
        ...
        */
        void ColorsPerIndividual(vector<vector<int>> &old_colors){
