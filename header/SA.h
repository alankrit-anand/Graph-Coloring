...
class SA{
    public:
        ...
        SA(double initial_temperature,int n_nodes,int n_edges ,vector<vector<int>> main_graph);

        //
        SA(double initial_temperature,int coolMode, int alpha,int n_nodes,int n_edges ,vector<vector<int>> main_graph);
        ...
        */
        void MainLoop(int max_iterations, double min_temp, int &total_iterations, int min_colors);
